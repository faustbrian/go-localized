// Package localizedconfig adapts Text to go-config's value-hook contracts.
...
// Text is a presence-aware go-config value hook.
type Text struct {
...
// UnmarshalConfigValue implements go-config's ValueUnmarshaler contract.
