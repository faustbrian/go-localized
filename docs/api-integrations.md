...
Place the canonical object directly in an attribute accepted by go-jsonapi:
...
Use the same object in go-jsonrpc params or results:
...
contract as a key regex. Parse keys with `go-international/locale` through this
