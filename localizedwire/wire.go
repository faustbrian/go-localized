// Package localizedwire adapts Text to bounded go-wire format packages.
...
// EncodeJSON encodes canonical keys through go-wire's bounded JSON encoder.
...
// DecodeJSON validates go-wire boundaries, then applies canonical duplicate and
...
// EncodeYAML encodes canonical keys through go-wire's bounded YAML encoder.
...
// EncodeTOML encodes canonical keys through go-wire's bounded TOML encoder.
...
// EncodeMessagePack encodes canonical keys through go-wire's deterministic
