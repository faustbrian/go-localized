...
[![CI](https://github.com/faustbrian/go-localized/actions/workflows/ci.yml/badge.svg)](https://github.com/faustbrian/go-localized/actions/workflows/ci.yml)
[![PostgreSQL](https://github.com/faustbrian/go-localized/actions/workflows/postgres.yml/badge.svg)](https://github.com/faustbrian/go-localized/actions/workflows/postgres.yml)
[![Mutation](https://github.com/faustbrian/go-localized/actions/workflows/mutation.yml/badge.svg)](https://github.com/faustbrian/go-localized/actions/workflows/mutation.yml)
[![Fuzz](https://github.com/faustbrian/go-localized/actions/workflows/fuzz.yml/badge.svg)](https://github.com/faustbrian/go-localized/actions/workflows/fuzz.yml)
[![Security](https://github.com/faustbrian/go-localized/actions/workflows/security.yml/badge.svg)](https://github.com/faustbrian/go-localized/actions/workflows/security.yml)
[![Benchmarks](https://github.com/faustbrian/go-localized/actions/workflows/benchmark.yml/badge.svg)](https://github.com/faustbrian/go-localized/actions/workflows/benchmark.yml)
[![Release](https://github.com/faustbrian/go-localized/actions/workflows/release.yml/badge.svg)](https://github.com/faustbrian/go-localized/actions/workflows/release.yml)

`go-localized` provides immutable UTF-8 text keyed by canonical BCP 47 language
...
- caller maps, entry slices, rows, iterators, and encoded bytes do not alias
  retained state;
- locale keys use canonical `go-international/locale.Tag` identity;
